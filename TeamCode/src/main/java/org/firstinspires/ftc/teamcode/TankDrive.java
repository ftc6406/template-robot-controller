...
public final class TankDrive {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public PoseVelocity2d update() {
            ...
            FlightRecorder.write("TANK_LOCALIZER_INPUTS",
                    new TankLocalizerInputsMessage(leftReadings,
                            rightReadings));
            ...
            Twist2dDual<Time> twist =
                    kinematics.forward(new TankKinematics.WheelIncrements<>(
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            Pose2dDual<Arclength> txWorldTarget =
                    timeTrajectory.path.get(x.value(), 3);
            targetPoseWriter.write(new PoseMessage(txWorldTarget.value()));

            updatePoseEstimate();

            PoseVelocity2dDual<Time> command =
                    new RamseteController(kinematics.trackWidth,
                            PARAMS.ramseteZeta, PARAMS.ramseteBBar)
            ...
            tankCommandWriter.write(new TankCommandMessage(voltage, leftPower
                    , rightPower));
